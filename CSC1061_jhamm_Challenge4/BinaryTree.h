...
template <class T> inline treeNode<T> BinaryTree<T>::getRoot() { return *root; }

template <class T> inline BinaryTree<T>::BinaryTree(T root) { add(T); }
...
template <class T> inline bool BinaryTree<T>::isEmpty() { return root == NULL; }
